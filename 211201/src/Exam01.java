...
짝수이면서 4백만 이하인 모든 항을 더하면 얼마가 됩니까?
 ...
 문제 4)
 어떤 숫자를 입력 받았을 때 그 숫자를 2진법으로 출력하는 프로그램을 작성하시오.

 문제 5)
 앞에서부터 읽을 때나 뒤에서부터 읽을 때나 모양의 같은 수를 대칭수(palindrome)라고 부릅니다.
...
public class Exam01 {
	...
	// 문제 4
	System.out.println("2진수로 나타낼 숫자 입력 : ");
	n = sc.nextInt();
	System.out.println(n + " : " + Integer.toBinaryString(n)); // 2진수로 바뀜
	System.out.println(n + " : " + Integer.toString(n,2)); // (n을, 2)진수로 바꿔라
	sc. close();
