...
// upCasting   : 자식의 객체를 부모 변수에 대입한다.
// downCasting : 부모의 객체를 자식의 변수에 대입한다. 
...
public class UpDownEx {
	public static void main(String[] args) {
		...
		// 부모타입을 형변환해서 자식에 대입할때는 반드시 instanceof 연산자로 판단해서 사용해라 (실행오류 방지) 
		...
		// 대입 가능여부를 판단하는 연산자 : intstanceof(왼쪽의 객체를 오른쪽 타입으로 변환이 가능하냐?)
