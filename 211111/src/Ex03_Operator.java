public class Ex03_Operator {
	...
	public static void main(String[] args) {
		int n = 0XAABBCCDD; //16진수로 초기화 2진수 4자리는 16진수 한자리다.
		...
		int high = n >> 4;
		System.out.println("상위 4비트 : " + Integer.toHexString(high));
		// 하위 4비트 취하기 : 앞에 4비트만 지운다
		int low = n & 0x0F;
		System.out.println("하위 4비트 : " + Integer.toHexString(low));
		
		// 10진수 159를 위의 분리하는 방법으로 16진수로 출력하시오
		n = 159;
		...
		System.out.println((char)('A' + 3)); // '5'로 출력하려면 + '0' 을 해줘야 한다.
