...
public class Ex05_Operator {
	...
	public static void main(String[] args) {
		...
		int n = 1;
		while(n !=0) {
			System.out.print("1~255사이의 양의 정수를 입력하시오 (0은종료)");
			n = sc.nextInt();
			if(n==0) continue;
			if(n<0) {
		...
		// 1000 0000 => mask 
		// ---- ----	AND
		// 0000 0000 => mask와 같냐?  001 ==> 결국 같아지는 경우는 위의 비트값이 1인 경우만이다.
