...
public class Ex02_Array {
	public static void main(String[] args) {
		...
		ar1 = new int[5];
		System.out.println(ar1); // [I@53bd815b 출력 : 주소를 저장하고있다 ==> 참조형 변수이다.
		...
		// ar1[5] = 100; // 컴파일 에러가 아니다. 하지만 실행시 에러(런타임에러)가 발생한다.
					  // ArrayIndexOutOfBoundsException 예외 발생 (첨자 잘못 설정)
		...
		int ar3[];
		//ar3 = {11,22,33,44,55,66,77,88}; 선언후 {}로 초기화 할수 없다
		ar3 = new int [] {11,22,33,44}; // 선언후 초기화는 new 연산자로 값을 할당해야한다.
