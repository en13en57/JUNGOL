...
public class Exam_220113_02 {
	...
	@Test
	public void test() {
		assertArrayEquals(new Exam_220113_02().solution(new int[][] {{1,2},{2,3}}, new int[][] {{3,4},{5,6}}), new int[][] {{4,6},{7,9}});
		assertArrayEquals(new Exam_220113_02().solution(new int[][] {{1},{2}}, new int[][] {{3},{4}}), new int[][] {{4},{6}});
