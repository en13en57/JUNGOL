...
public class Exam_220105_01 {
	...
	@Test
	public void test() {
		assertEquals(new Exam_220105_01().solution("1S2D*3T"), 37);
		assertEquals(new Exam_220105_01().solution("1D2S#10S"), 9);
		assertEquals(new Exam_220105_01().solution("1D2S0T"), 3);
		assertEquals(new Exam_220105_01().solution("1S*2T*3S"), 23);
		assertEquals(new Exam_220105_01().solution("1D#2S*3S"), 5);
		assertEquals(new Exam_220105_01().solution("1T2D3D#"), -4);
		assertEquals(new Exam_220105_01().solution("1D2S3T*"), 59);
	}
}
