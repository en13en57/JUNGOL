...
*/
public class Exam_220111_04 {

	public long solution(long n) { // sqrt 루트값 , pow 제곱값(어떤것, 몇승)
	...
	@Test
	public void test() {
		assertEquals(new Exam_220111_04().solution(121), 144);
		assertEquals(new Exam_220111_04().solution(3), -1);
	}
}
