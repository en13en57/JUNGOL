...
public class Exam_211228_01 {
	...
	@Test
	public void test() {
		assertArrayEquals(new Exam_211228_01().solution(new int[] {1,2,3,4,5}), new int[] {1});
		assertArrayEquals(new Exam_211228_01().solution(new int[] {1,3,2,4,2}), new int[] {1,2,3});
	}
