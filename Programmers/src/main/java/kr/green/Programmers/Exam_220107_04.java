...
public class Exam_220107_04 {
	...
	@Test
	public void test() {
		assertEquals(new Exam_220107_04().solution(10), 4);
		assertEquals(new Exam_220107_04().solution(5), 3);
	}
	@Test
	public void test2() {
		assertEquals(new Exam_220107_04().solution2(10), 4);
		assertEquals(new Exam_220107_04().solution2(5), 3);
	}
}
