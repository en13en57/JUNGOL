...
public class Exam_220110_05 {
	...
	@Test
	public void test() {
		assertEquals(new Exam_220110_05().solution("try hello     world"), "TrY HeLlO     WoRlD");
		assertEquals(new Exam_220110_05().solution("ab ab ab ab"), "Ab Ab Ab Ab");
	}
}
