...
입출력 예 #2
모든 사용자가 마지막 스테이지에 있으므로 4번 스테이지의 실패율은 
1이며 나머지 스테이지의 실패율은 0이다.

[4,1,2,3]
 */
public class Exam_211230_01 {
	...
	public int[] solution(int n, int[] stages) {
		...
		Collections.sort(list, new Comparator<Map.Entry<Integer, Double>>() {
			...
			public int compare(Entry<Integer, Double> o1, Entry<Integer, Double> o2) {
				double comint = (o1.getValue() - o2.getValue()) * -1;
	...
	@Test
	public void test() {
		assertArrayEquals(new Exam_211230_01().solution(5, new int[] {2, 1, 2, 6, 2, 4, 3, 3}), new int[] {3,4,2,1,5});
		assertArrayEquals(new Exam_211230_01().solution(4, new int[] {4,4,4,4,4}), new int[] {4,1,2,3});
	}
}
